        ...
        <div className="blog-sections">
          <div className="blog-detail-section">
            ...
            <div className="blog-detail-section5">
              <div>
                <svg
                  class="mt-1.5 ltr:mr-2 rtl:ml-2 neg-transition-scale absolute w-3 h-2 lg:w-4 lg:h-2.5"
                  width="15"
                  height="10"
                  viewBox="0 0 15 10"
                  fill="none"
              ...
              <div>
                <p>Next Post</p>
                <svg
                  class="ltr:ml-2 rtl:mr-2 neg-transition-scale relative w-3 h-2 lg:w-4 lg:h-2.5"
                  width="15"
                  height="10"
                  viewBox="0 0 15 10"
                  fill="none"
