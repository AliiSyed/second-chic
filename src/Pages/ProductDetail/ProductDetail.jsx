              ...
              <Slider {...settings}>
                ...
                <div>
                  <img
                    ...
                    alt="productDetail3.png"
                  />
                </div>
                <div>
                  <img
                    src="/images/productDetail4.png"
                    alt="productDetail4.png"
                  />
                </div>
              </Slider>
            </div>
          ...
          <div className="product-detail-content-left-section2">
            <section>
              <p>
                ...
                Temporibus, nulla culpa nesciunt maxime vel eligendi voluptates
                sint voluptatum eius cupiditate? Numquam, nihil fugit quis quas
                perferendis nisi ducimus officiis odio!Lorem ipsum, dolor sit
                amet consectetur adipisicing elit. Temporibus, nulla culpa
                nesciunt maxime vel eligendi voluptates sint voluptatum eius
                cupiditate? Numquam, nihil fugit quis quas perferendis nisi
                ducimus officiis odio!Lorem ipsum, dolor sit amet consectetur
                adipisicing elit. Temporibus, nulla culpa nesciunt maxime vel
                eligendi voluptates sint voluptatum eius cupiditate? Numquam,
                nihil fugit quis quas perferendis nisi ducimus officiis odio!
              </p>
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maxime
                nam voluptate impedit, quam, fugiat consequuntur itaque
                voluptatum quibusdam neque similique exercitationem pariatur
                ipsum incidunt dolores. Itaque a distinctio deserunt
                ratione!Lorem ipsum, dolor sit amet consectetur adipisicing
                elit. Temporibus, nulla culpa nesciunt maxime vel eligendi
                voluptates sint voluptatum eius cupiditate? Numquam, nihil fugit
                quis quas perferendis nisi ducimus officiis odio!
              </p>
            </section>
        ...
        <div className="product-detail-content-right">
          <div className="product-detail-content-right-section1">
            ...
            <button>
              <p>Go to Store</p>
              <svg
                class="relative ltr:ml-2 rtl:mr-2 neg-transition-scale"
                width="12"
                height="7"
                viewBox="0 0 12 7"
                fill="none"
